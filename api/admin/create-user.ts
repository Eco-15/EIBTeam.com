...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const { email, firstName, lastName, dateOfBirth, role, temporaryPassword } = req.body;
    ...
    await DatabaseService.createAgentProfile({
    ...
    // Create user role
    await DatabaseService.createUserRole({
      userId: result.user.id,
      role,
